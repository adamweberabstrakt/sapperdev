 ...
 * it by dispatching a window "open-booking" event. Renders the BookingForm,
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
      <div
        ...
        aria-hidden
      />
      <div className="relative w-full max-w-md border-t-2 border-acid bg-panel p-7 ring-1 ring-steel/20">
        <button
          onClick={() => setOpen(false)}
          aria-label="Close"
        ...
        <p className="mb-5 mt-2 text-sm text-bone/60">
          {"Tell us where to route you — the calendar opens on the next screen."}
        </p>
        <BookingForm />
      </div>
    </div>
