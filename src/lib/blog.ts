...
export const CATEGORIES: { slug: BlogCategory; label: string; blurb: string }[] = [
  ...
  { slug: "news", label: "News", blurb: "What's new at Northbound and across B2B outbound." },
...
const GENERIC: Block[] = [
  ...
  { type: "p", text: "Every channel works the same named decision-makers — until the meetings land. That's the through-line for everything Northbound publishes here." },
];
...
export const POSTS: BlogPost[] = [
  {
    ...
    content: [
      ...
      { type: "callout", text: "Disclosure: Northbound produced this article and included itself in the ranking — applying the same scoring criteria to our own program that we applied to every other agency on the list." },
      { type: "h2", text: "The scoring results" },
      {
        type: "table",
        headers: ["Agency", "Mfg.", "Channels", "List", "Results", "Acct.", "Total"],
        rows: [
          ["Northbound", "25", "23", "18", "19", "10", "95"],
          ["Northbound", "22", "24", "18", "18", "9", "91"],
      ...
      { type: "p", text: "The guarantee: if Northbound doesn't hit your annual meeting goal, they work the following quarter for free — no conditions buried in the contract." },
    ],
  },
  {
  ...
  },
  {
    ...
    title: "How a Managed IT Firm Booked 70% of Its Annual Sales with Northbound",
    excerpt: "An IT expert with no sales background opened a franchise — and Northbound's prospecting became the engine behind the majority of its revenue.",
    category: "success",
    author: "Amie Milner",
    date: "2026-02-02",
    readTime: "6 min read",
  ...
  },
  {
    ...
    title: "Northbound Expands Its St. Louis Outbound Team to 400+",
  ...
  },
  {
    ...
    title: "Northbound Joins Forces with Northbound",
    excerpt: "Combining a data-driven outbound engine with Northbound's scale and multi-channel reach to fix B2B pipeline at scale.",
    category: "news",
    author: "Northbound Team",
    date: "2025-11-12",
    readTime: "4 min read",
  ...
  },
  {
    ...
    title: "Northbound Named a Top Lead Generation Company for Manufacturing",
  ...
  },
  {
    ...
    title: "Northbound Featured on the Return of Direct-Mail-Led Outbound",
